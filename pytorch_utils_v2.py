...
def plot_confusion_metrix_with_mlextend(model, y_pred_tensor, test_data class_names):
    confmat = ConfusionMatrix(num_classes=len(class_names))
    comfmat_tensor = confmat(preds=y_pred_tensor, target=test_data.targets)

    fig, ax = plot_confution_matrix(confmat_tensor.numpy(), class_names=class_names, figsize=(10, 7));